...
window.onload = function() {
	...
	image.src = "http://192.168.18.72:8080/images/background2.png";
...
function search() {
	...
	if (searchText === "") {
		...
		axios.get('http://192.168.18.72:8080/getHighScore?name=' + searchText).then(async function(response) {
...
function getHighScores() {
	document.getElementById("highScores").style.display = "none";
	axios.get('http://192.168.18.72:8080/highscore')
...
function back() {
	location.href = "http://192.168.18.72:8080/start"
}
